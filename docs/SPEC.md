...
| プリセット名 | サイズ         | 用途                         |
| ------------ | -------------- | ---------------------------- |
| Small        | 128 x 128 px   | 軽量・アップロード制限対策   |
| Default      | 400 x 400 px   | 汎用（X、TikTok、Bluesky等） |
| Large        | 800 x 800 px   | 高解像度（YouTube等）        |
| XLarge       | 1024 x 1024 px | 高画質保存用                 |

- デフォルト選択は「Default（400 x 400 px）」
